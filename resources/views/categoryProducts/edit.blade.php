...
<main class="full-box main-container">
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-sync-alt"></i> &nbsp; ACTUALISER UNE CATÉGORIE
                </h3>
            ...
            <!--CONTENT-->
            <div class="container-fluid">
                <form action="{{ route('categoryProducts.update',["categoryProduct"=>$categoryProduct->id]) }}" class="form-neon" autocomplete="off" method='post'>
                    @csrf
                    @method('PATCH')
					<fieldset>
						<legend><i class="fas fa-pallet fa-fw"></i> &nbsp; Informations sur la catégorie</legend>
						<div class="container-fluid">
                            <div class="form-row">
                                <div class="form-group col-md-12 mt-4">
                                <label for="inputName">Name</label>
                                <input type="text" class="form-control" name="inputName" placeholder="Nom de la catégorie" value="{{ $categoryProduct->name }}">
                                @error('inputName')
